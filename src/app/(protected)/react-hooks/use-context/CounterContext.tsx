...
import { ChangeEvent, createContext, FC, ReactElement, useCallback, useContext, useReducer } from 'react'
...
export const CounterProvider: FC<{children: ReactElement}> = ({ children }) => {
  return (
